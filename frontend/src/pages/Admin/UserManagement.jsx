...
export default function UserManagement() {
  ...
  return (
    <div className="user-mgmt">
      ...
      {editModal ? (
        <DetailModal isOpen={true} title="Chỉnh sửa người dùng" onClose={() => setEditModal(null)} height="auto">
          <DetailModal.Card>
      ...
      {addModalOpen ? (
        <DetailModal isOpen={true} title={`Thêm ${meta.label}`} onClose={() => setAddModalOpen(false)} width="auto">
          <DetailModal.Card>
            <label className="user-mgmt__dialogField">
              <span>Họ tên <span className="required-asterisk">*</span></span>
              <input
